...
export const MULTILINGUAL_MISSIONS: WeeklyMission[] = [
  ...
  // =========================================================================
  // 🇷🇺 RUSSO (РУССКИЙ) - SEMANAS 1, 2 E 3
  // =========================================================================
  {
    id: "ru-w1-tea",
    language: "ru",
    week: 1,
    weekTitle: "Semana 1: Sobrevivência em Moscou",
    title: "Pedir Chá Quente & Blini em Moscou",
    icon: "Coffee",
    focus: "Cafeteria, chá tradicional & sobremesas",
    situationDescription:
      "Você entra em um charmoso café na rua Arbat, em Moscou. O atendente te cumprimenta em russo e você quer pedir um chá preto bem quente com limão, blinis caseiros com mel e pedir para saborear no local.",
    aiRole: "Atendente na Casa de Chá no Arbat",
    userRole: "Cliente em Moscou",
    openingAiDialogue: "Здравствуйте! Добро пожаловать. Что для вас приготовить сегодня?",
    openingAiPhonetic: "Zdrást-vuy-tye! Da-bró pa-zhá-la-vat'. Shto dlya vas pri-ga-tó-vit' se-vód-nya?",
    openingAiPortuguese: "Olá! Boas-vindas. O que posso preparar para você hoje?",
    survivalObjective: "Pedir um chá preto grande com limão (чёрный чай с лимоном), blinis com mel (блины с мёдом) e confirmar pagamento com cartão.",
    survivalTipsPt: "Diga 'Чёрный чай с лимоном и блины, пожалуйста' (Tchór-nyy tchai s li-mó-nam i bli-ný, pa-zhá-luy-sta). Para pagar: 'Можно картой?' (Mózh-na kár-tay?).",
    sampleResponses: [
      "Здравствуйте! Большой чёрный чай с лимоном, пожалуйста.",
      "У вас есть свежие блины с мёдом или ягодами?",
      "Можно оплатить картой?",
    ],
    structuredSuggestions: [
      {
        english: "Большой чёрный чай с лимоном и блины с мёдом, пожалуйста.",
        phonetic: "Bal'-shóy tchór-nyy tchai s li-mó-nam i bli-ný s myó-dam, pa-zhá-luy-sta.",
        portuguese: "Um chá preto grande com limão e blinis com mel, por favor.",
      },
      {
        english: "Подскажите, сколько это стоит?",
        phonetic: "Pat-ska-zhí-tye, skól'-ka é-ta stó-it?",
        portuguese: "Poderia me dizer quanto custa isto?",
      },
      {
        english: "Можно оплатить бесконтактно картой?",
        phonetic: "Mózh-na ap-la-tít' byes-kan-tákt-na kár-tay?",
        portuguese: "Posso pagar por aproximação com cartão?",
      },
    ],
    script: [
      {
        ...
        speaker: "Atendente",
        roleType: "ai",
        english: "Здравствуйте! Добро пожаловать. Что будете заказывать?",
        phonetic: "Zdrást-vuy-tye! Da-bró pa-zhá-la-vat'. Shto bú-dye-tye za-ká-zy-vat'?",
        portuguese: "Olá! Boas-vindas. O que vai pedir?",
      },
      {
        id: "ru-w1t-2",
        speaker: "Você",
        roleType: "user",
        english: "Здравствуйте! Мне, пожалуйста, чёрный чай с лимоном и порцию блинов.",
        phonetic: "Zdrást-vuy-tye! Mnye, pa-zhá-luy-sta, tchór-nyy tchai s li-mó-nam i pór-tsi-yu bli-nóf.",
        portuguese: "Olá! Para mim, por favor, um chá preto com limão e uma porção de blinis.",
      },
      {
        id: "ru-w1t-3",
        speaker: "Atendente",
        roleType: "ai",
        english: "Отличный выбор! Вам здесь или с собой?",
        phonetic: "At-lítch-nyy vý-bar! Vam zdyes' í-li s sa-bóy?",
        portuguese: "Excelente escolha! Para tomar aqui ou para viagem?",
      },
      {
        id: "ru-w1t-4",
        speaker: "Você",
        roleType: "user",
        english: "Здесь, пожалуйста. И можно оплатить картой?",
        phonetic: "Zdyes', pa-zhá-luy-sta. I mózh-na ap-la-tít' kár-tay?",
        portuguese: "Aqui, por favor. E posso pagar com cartão?",
      },
    ],
  },
  {
    ...
    language: "ru",
    week: 2,
    weekTitle: "Semana 2: Transporte & Mobilidade",
    title: "Navegar no Metrô de São Petersburgo",
    icon: "Navigation",
    focus: "Transporte público, bilhete & orientações",
    situationDescription:
      "Você está na suntuosa estação de metrô em São Petersburgo. Precisa comprar uma passagem e perguntar ao funcionário como fazer baldeação para chegar à Avenida Névski.",
    aiRole: "Funcionário da Estação de Metrô",
    userRole: "Passageiro internacional",
    openingAiDialogue: "Добрый день! Касса метро. Сколько жетонов или поездок вам нужно?",
    openingAiPhonetic: "Dó-bryy dyen'! Kás-sa mi-tró. Skól'-ka zhe-tó-naf í-li pa-yézd-ak vam núzh-na?",
    openingAiPortuguese: "Boa tarde! Guichê do metrô. Quantos bilhetes ou viagens você precisa?",
    survivalObjective: "Comprar um cartão de transporte, pedir indicação de direção e saber onde descer para o Nevsky Prospect.",
    survivalTipsPt: "Use 'Как доехать до Невского проспекта?' (Kak da-yé-khat' da Nyév-ska-va pras-pyék-ta?). Para confirmar a linha: 'Какая это линия?' (Ka-ká-ya é-ta lí-ni-ya?).",
    sampleResponses: [
      "Мне, пожалуйста, одну карту 'Тройка' или жетон.",
      "Как быстрее доехать до станции 'Невский проспект'?",
      "Здесь нужно делать пересадку?",
    ],
    structuredSuggestions: [
      {
        english: "Один билет на метро, пожалуйста. Как доехать до Невского проспекта?",
        phonetic: "A-dín bi-lyét na mi-tró, pa-zhá-luy-sta. Kak da-yé-khat' da Nyév-ska-va pras-pyék-ta?",
        portuguese: "Uma passagem de metrô, por favor. Como chegar à Avenida Névski?",
      },
      {
        english: "На какой станции мне нужно делать пересадку?",
        phonetic: "Na ka-kóy stán-tsi-i mnye núzh-na dyé-lat' pi-ri-sát-ku?",
        portuguese: "Em qual estação eu preciso fazer a baldeação?",
      },
      {
        english: "Большое спасибо за помощь!",
        phonetic: "Bal'-shó-ye spa-sí-ba za pó-mashch'!",
        portuguese: "Muito obrigado pela ajuda!",
      },
    ],
    script: [
      {
        ...
        speaker: "Funcionário",
        roleType: "ai",
        english: "Добрый день! Слушаю вас.",
        phonetic: "Dó-bryy dyen'! Slú-sha-yu vas.",
        portuguese: "Boa tarde! Pois não.",
      },
      {
        id: "ru-w2m-2",
        speaker: "Você",
        roleType: "user",
        english: "Здравствуйте! Один билет, пожалуйста. Как доехать до Невского проспекта?",
        phonetic: "Zdrást-vuy-tye! A-dín bi-lyét, pa-zhá-luy-sta. Kak da-yé-khat' da Nyév-ska-va pras-pyék-ta?",
        portuguese: "Olá! Uma passagem, por favor. Como faço para chegar ao Nevsky Prospect?",
      },
      {
        id: "ru-w2m-3",
        speaker: "Funcionário",
        roleType: "ai",
        english: "Садитесь на синюю линию, ехать три остановки прямо без пересадок.",
        phonetic: "Sa-dí-tyes' na sí-nyu-yu lí-ni-yu, yé-khat' tri as-ta-nóf-ki pryá-ma byez pi-ri-sá-dak.",
        portuguese: "Pegue a linha azul, são três paradas direto, sem baldeação.",
      },
      {
        id: "ru-w2m-4",
        speaker: "Você",
        roleType: "user",
        english: "Отлично! Спасибо огромное, хорошего дня.",
        phonetic: "At-lítch-na! Spa-sí-ba ag-róm-na-ye, kha-ró-sha-va dnya.",
        portuguese: "Excelente! Muitíssimo obrigado, tenha um bom dia.",
      },
    ],
  },
  {
    ...
    language: "ru",
    week: 3,
    weekTitle: "Semana 3: Social & Vida na Cidade",
    title: "Encontro Cultural na Praça Vermelha",
    icon: "Compass",
    focus: "Conversação casual, planos culturais & clima",
    situationDescription:
      "Você marcou um encontro em frente ao histórico shopping GUM, na Praça Vermelha em Moscou, com sua tutora Elena. Vocês comentam sobre o clima, admiram a arquitetura e decidem os planos para a tarde.",
    aiRole: "Elena (sua amiga moscovita)",
    userRole: "Amigo visitante",
    openingAiDialogue: "Привет! Какая радость встретиться на Красной площади! Как тебе наш город?",
    openingAiPhonetic: "Pri-vyét! Ka-ká-ya rá-dast' fstryé-tit'-sya na Krás-nay pló-shcha-di! Kak ti-byé nash gó-rat?",
    openingAiPortuguese: "Oi! Que alegria nos encontrarmos na Praça Vermelha! O que você está achando da nossa cidade?",
    survivalObjective: "Expressar encanto com a arquitetura, falar sobre o clima e sugerir ir à Galeria Tretiakov ou tomar um chocolate quente.",
    survivalTipsPt: "Diga 'Город невероятно красивый!' (A cidade é incrivelmente linda!). Para propor um plano: 'Пойдём выпьем горячий шоколад?' (Vamos tomar um chocolate quente?).",
    sampleResponses: [
      "Привет, Елена! Площадь выглядит просто сказочно.",
      "Здесь довольно прохладно сегодня, но очень красиво.",
      "Может быть, зайдём в уютное кафе выпить горячего чая?",
    ],
    structuredSuggestions: [
      {
        english: "Привет! Город просто потрясающий, особенно собор Василия Блаженного.",
        phonetic: "Pri-vyét! Gó-rat prós-ta pat-rya-sá-yu-shchiy, a-syé-byen-na sa-bór Va-sí-li-ya Bla-zhén-na-va.",
        portuguese: "Oi! A cidade é simplesmente espetacular, especialmente a Catedral de São Basílio.",
      },
      {
        english: "Погода прохладная, давай зайдём внутрь и выпьем горячий чай?",
        phonetic: "Pa-gó-da prakh-lád-na-ya, da-váy zay-dyóm vnukhtr' i výp'-yem ga-ryá-tchiu tchai?",
        portuguese: "O tempo está fresquinho, vamos entrar e tomar um chá quente?",
      },
      {
        english: "Куда мы отправимся потом: в Третьяковскую галерею или в парк?",
        phonetic: "Ku-dá my at-prá-vim-sya pa-tóm: v Tri-t'ya-kóf-sku-yu ga-li-ryé-yu í-li v park?",
        portuguese: "Para onde vamos depois: à Galeria Tretiakov ou ao parque?",
      },
    ],
    script: [
      {
        ...
        speaker: "Elena",
        roleType: "ai",
        english: "Привет! Как добрался? Не замёрз на улице?",
        phonetic: "Pri-vyét! Kak dab-rál-sya? Nye za-myórz na ú-li-tse?",
        portuguese: "Oi! Como foi o trajeto? Não ficou com frio na rua?",
      },
      {
        id: "ru-w3r-2",
        speaker: "Você",
        roleType: "user",
        english: "Привет, Елена! Всё отлично. Вид на Кремль просто захватывает дух!",
        phonetic: "Pri-vyét, Ye-lyé-na! Fsyo at-lítch-na. Vid na Kryeml' prós-ta zakh-vá-ty-va-yet dukh!",
        portuguese: "Oi, Elena! Tudo ótimo. A vista do Kremlin é simplesmente de tirar o fôlego!",
      },
      {
        id: "ru-w3r-3",
        speaker: "Elena",
        roleType: "ai",
        english: "Да, это моё любимое место в Москве. Предлагаю взять горячий напиток и прогуляться.",
        phonetic: "Da, é-ta ma-yó lyu-bí-ma-ye myés-ta v Mask-vyé. Pryed-la-gá-yu vzyat' ga-ryá-tchiu na-pí-tak i pra-gul-yát'-sya.",
        portuguese: "Sim, é o meu lugar favorito em Moscou. Proponho pegar uma bebida quente e passear.",
      },
      {
        id: "ru-w3r-4",
        speaker: "Você",
        roleType: "user",
        english: "Замечательная идея! С удовольствием прогуляюсь с тобой.",
        phonetic: "Za-mi-tchá-tyel'-na-ya i-dyé-ya! S u-da-vól'st-vi-yem pra-gul-yá-yus' s ta-bóy.",
        portuguese: "Ideia maravilhosa! Com muito prazer vou passear com você.",
      },
    ],
  },
];
