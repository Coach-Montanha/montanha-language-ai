...
import { WEEKLY_MISSIONS, getMissionsByWeek } from "@/data/missions";
...
export const DailyMissionBanner: React.FC<DailyMissionBannerProps> = ({
  ...
  return (
    <div className="mx-auto w-full max-w-lg px-3 pt-2 pb-1 space-y-2">
      ...
      <div className="rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-card via-card to-primary/5 p-3.5 shadow-sm space-y-2.5">
